...
ADD CONSTRAINT unique_tech_name UNIQUE (Tech_Name);
...
(6, 'Java', 'Back-end', 'https://example.com/java_full_stack_program', 1, 1, true, 'This program covers Angular', 'Active', '2024-03-07 16:49:26', 6);
update maker_program set Tech_Type_Id = 3 where Program_Type = 'Back-end';
SET SQL_SAFE_UPDATE = 0;
DELIMITER //
